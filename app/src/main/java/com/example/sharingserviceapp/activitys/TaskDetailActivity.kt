...
class TaskDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // You can now fetch the task details using the taskId
...
//            updateTaskStatus("Declined")  // Update the task status to Declined
    ...
    private fun loadTaskDetailed(taskId: Int) {
        ...
        val call = api.getMyTasksById("Bearer $token", taskId) // Make sure this function exists in your API interface
